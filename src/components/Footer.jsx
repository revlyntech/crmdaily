...
export default function Footer() {
  ...
  return (
    <footer>
      <style>{`
        .footer-newsletter { background: #E8521A; padding: 56px 32px; text-align: center; }
        ...
        .footer-form button { background: #0F0E0D; color: #fff; border: none; padding: 14px 24px; font-family: 'Space Mono',monospace; font-size: 10px; font-weight: 700; letter-spacing: 0.1em; cursor: pointer; flex-shrink: 0; white-space: nowrap; }
      ...
      <div className="footer-newsletter">
        <div style={{ maxWidth: 600, margin: "0 auto" }}>
          <span style={{ fontFamily:"'Space Mono',monospace", fontSize:10, color:"#0F0E0D", letterSpacing:"0.2em", display:"block", marginBottom:12 }}>// JOIN THE DAILY DIGEST</span>
          <h2>Start your day with CRM intelligence.</h2>
          <p style={{ fontFamily:"'Space Mono',monospace", fontSize:12, color:"#0F0E0D", marginBottom:28, lineHeight:1.7 }}>
