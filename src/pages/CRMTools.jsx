...
export default function CRMTools() {
  ...
  return (
    <div className="fade-in">
      <SEOMeta
        title="CRM Tools Directory 2026"
        description="Explore the best CRM tools, sales engagement platforms, and revenue intelligence software. Curated by CRM Daily."
        url="https://www.crmdaily.co/crm-tools"
      />

      {/* Hero */}
      <div style={{ background: "#0F0E0D", padding: "72px 32px 56px" }}>
        <div style={{ maxWidth: 1400, margin: "0 auto" }}>
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            ...
            <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", flexWrap: "wrap", gap: 24, marginBottom: 32 }}>
              <h1 style={{ fontFamily: "'DM Serif Display',serif", fontSize: 56, color: "#F2EDE4", letterSpacing: "-0.02em", lineHeight: 1.05, margin: 0 }}>
                CRM & Sales Tools
              </h1>
            ...
            <input
              type="text"
              placeholder="Search tools — HubSpot, Clay, Gong..."
              value={search}
              onChange={e => setSearch(e.target.value)}
              style={{ width: "100%", maxWidth: 520, background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.12)", color: "#F2EDE4", fontFamily: "'Space Mono',monospace", fontSize: 11, padding: "14px 20px", outline: "none", boxSizing: "border-box", letterSpacing: "0.06em", transition: "border-color 0.2s" }}
      ...
      {/* Tools Grid */}
      <div className="grid-bg" style={{ background: "#F2EDE4", padding: "48px 32px 96px" }}>
        <div style={{ maxWidth: 1400, margin: "0 auto" }}>
...
function ToolCard({ tool, index }) {
  return (
    ...
    >
      ...
      {/* Description */}
      <p style={{ fontFamily: "'Inter',sans-serif", fontSize: 13, color: "#6B6560", lineHeight: 1.7, margin: 0, flex: 1, display: "-webkit-box", WebkitLineClamp: 3, WebkitBoxOrient: "vertical", overflow: "hidden" }}>
        {tool.description}
      </p>
