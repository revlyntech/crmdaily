...
export default function About() {
  ...
  return (
    <>
      <style>{`
        .about-hero { background: #0F172A; padding: 80px 32px; }
        .about-hero h1 { font-family: 'DM Serif Display',serif; font-size: 64px; color: #FAFBFC; letter-spacing: -0.02em; line-height: 1.05; max-width: 800px; }
      ...
      <div className="fade-in">
        <div className="about-hero">
          <div style={{ maxWidth:1400, margin:"0 auto" }}>
            <motion.div initial={{ opacity:0, y:20 }} animate={{ opacity:1, y:0 }}>
              <span style={{ fontFamily:"'Space Mono',monospace", fontSize:10, color:"#E85D3A", letterSpacing:"0.15em", display:"block", marginBottom:20 }}>// ABOUT_CRMDAILY</span>
        ...
        <div style={{ background:"#E85D3A", padding:"28px 20px" }}>
          <div style={{ maxWidth:1400, margin:"0 auto" }}>
        ...
        <div className="grid-bg" style={{ background:"#FAFBFC", padding:"80px 32px" }}>
          <div style={{ maxWidth:1400, margin:"0 auto" }}>
            <div className="about-mission-grid">
              <div>
                <span style={{ fontFamily:"'Space Mono',monospace", fontSize:9, color:"#E85D3A", letterSpacing:"0.15em", display:"block", marginBottom:16 }}>// OUR_MISSION</span>
                <h2 style={{ fontFamily:"'DM Serif Display',serif", fontSize:40, color:"#0F172A", letterSpacing:"-0.02em", lineHeight:1.15, marginBottom:24 }}>CRM intelligence, without the vendor noise.</h2>
                ...
                <p style={{ fontFamily:"'Inter',sans-serif", fontSize:16, color:"#3D3A36", lineHeight:1.85, marginBottom:20 }}>We publish news, deep-dive guides, tool reviews, and GTM strategy analysis — every single day. No paywalls, no affiliate rankings dressed up as journalism.</p>
                <p style={{ fontFamily:"'Inter',sans-serif", fontSize:16, color:"#3D3A36", lineHeight:1.85 }}>CRM Daily is powered by <a href="https://revlyn.io" target="_blank" rel="noreferrer" style={{ color:"#E85D3A", textDecoration:"none", borderBottom:"1px solid #E85D3A" }}>Revlyn</a> — a specialist CRM, RevOps, and AI enablement agency. Our editorial is fully independent. No vendor sponsorships influence our coverage.</p>
              </div>
              <div style={{ display:"flex", flexDirection:"column", gap:0 }}>
                {values.map((v,i) => (
                  <div key={v.tag} style={{ padding:"28px 0", borderTop:"1px solid rgba(15,14,13,0.12)", borderBottom:i===values.length-1?"1px solid rgba(15,14,13,0.12)":"none" }}>
                    <span style={{ fontFamily:"'Space Mono',monospace", fontSize:9, color:"#E85D3A", letterSpacing:"0.15em", display:"block", marginBottom:10 }}>{v.tag}</span>
                    <h3 style={{ fontFamily:"'DM Serif Display',serif", fontSize:20, color:"#0F172A", marginBottom:8, letterSpacing:"-0.01em" }}>{v.title}</h3>
                    <p style={{ fontFamily:"'Space Mono',monospace", fontSize:11, color:"#64748B", lineHeight:1.85, margin:0 }}>{v.body}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div style={{ background:"#0F172A", padding:"64px 32px" }}>
          <div style={{ maxWidth:1400, margin:"0 auto" }}>
            <div className="about-revlyn-grid">
              <div>
                <span style={{ fontFamily:"'Space Mono',monospace", fontSize:9, color:"#E85D3A", letterSpacing:"0.15em", display:"block", marginBottom:16 }}>// POWERED_BY</span>
                <h2 style={{ fontFamily:"'DM Serif Display',serif", fontSize:36, color:"#FAFBFC", letterSpacing:"-0.02em", lineHeight:1.15, marginBottom:20 }}>Built by Revlyn.</h2>
                ...
                <a href="https://revlyn.io" target="_blank" rel="noreferrer"
                  style={{ display:"inline-block", border:"1px solid rgba(242,237,228,0.2)", color:"#FAFBFC", padding:"12px 24px", fontFamily:"'Space Mono',monospace", fontSize:10, letterSpacing:"0.1em", textDecoration:"none", transition:"all 0.2s" }}
                  onMouseEnter={e => { e.currentTarget.style.background="#E85D3A"; e.currentTarget.style.borderColor="#E85D3A"; }}
                  onMouseLeave={e => { e.currentTarget.style.background="transparent"; e.currentTarget.style.borderColor="rgba(242,237,228,0.2)"; }}>
                  VISIT REVLYN.IO ←
                </a>
              </div>
              <div style={{ background:"#E85D3A", padding:40 }}>
                ...
                <Link href="/newsletter" style={{ display:"inline-block", background:"#0F172A", color:"#fff", padding:"14px 28px", fontFamily:"'Space Mono',monospace", fontSize:11, fontWeight:700, letterSpacing:"0.1em", textDecoration:"none" }}
                  onMouseEnter={e => e.currentTarget.style.background="#1A1917"} onMouseLeave={e => e.currentTarget.style.background="#0F172A"}>
                  SUBSCRIBE FREE →
                </Link>
              </div>
            </div>
