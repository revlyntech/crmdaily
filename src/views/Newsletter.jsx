      ...
      <div className="fade-in">
        <div className="grid-bg-dark nl-hero" style={{ background:"#0F0E0D", padding:"100px 32px 80px", textAlign:"center", position:"relative", overflow:"hidden" }}>
          ...
          <motion.div initial={{opacity:0,y:30}} animate={{opacity:1,y:0}} transition={{duration:0.8}} style={{position:"relative"}}>
            ...
            <p style={{ fontFamily:"'Space Mono',monospace", fontSize:13, color:"rgba(242,237,228,0.5)", maxWidth:480, margin:"0 auto 40px", lineHeight:1.85 }}>Your morning CRM & GTM briefing. Top stories, tool updates, and actionable insights ΓÇö every weekday.</p>
            {status === "success" ? (
          ...
          <div style={{ maxWidth:900, margin:"0 auto" }}>
            ...
            <div className="nl-content-grid">
              {[
                ...
                { n:"02", icon:"≡ƒöº", title:"Tool Spotlight", desc:"One CRM tool reviewed briefly ΓÇö what it does, who it's for, and whether it's worth it." },
