  ...
  return (
    <>
      <style>{`
        ...
        .nl-form-row input { flex: 1; background: rgba(255,255,255,0.04); border: none; color: #FAFBFC; font-family: 'Inter',sans-serif; font-size: 14px; padding: 16px; outline: none; min-width: 0; }
      ...
      <div className="fade-in">
        <div className="grid-bg-dark nl-hero" style={{ background:"#0F172A", padding:"100px 32px 80px", textAlign:"center", position:"relative", overflow:"hidden" }}>
            ...
            {status === "success" ? (
              ...
              <form onSubmit={handleSubmit} className="nl-form-row">
                ...
                <button type="submit" disabled={status==="loading"}
                  style={{ background:"#E85D3A", color:"#fff", border:"none", padding:"16px 28px", fontFamily:"'Space Mono',monospace", fontSize:11, fontWeight:700, letterSpacing:"0.1em", cursor:"pointer", flexShrink:0, transition:"background 0.2s" }}
        ...
        <div className="grid-bg nl-body" style={{ background:"#FAFBFC", padding:"80px 32px 96px" }}>
          <div style={{ maxWidth:900, margin:"0 auto" }}>
            <h2 style={{ fontFamily:"'DM Serif Display',serif", fontSize:36, color:"#0F172A", textAlign:"center", marginBottom:48, letterSpacing:"-0.02em" }}>What arrives in your inbox every morning</h2>
            <div className="nl-content-grid">
              {[
                ...
                <motion.div key={b.n} className="nl-content-item" initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{delay:0.3+i*0.08}}
                  ...
                  <span style={{ fontFamily:"'Space Mono',monospace", fontSize:9, color:"#E85D3A", letterSpacing:"0.15em", display:"block", marginBottom:10 }}>{b.n} /</span>
                  <h3 style={{ fontFamily:"'DM Serif Display',serif", fontSize:22, color:"#0F172A", marginBottom:10 }}>{b.title}</h3>
                  <p style={{ fontFamily:"'Space Mono',monospace", fontSize:11, color:"#64748B", lineHeight:1.8 }}>{b.desc}</p>
                </motion.div>
              ))}
            </div>
          </div>
